...
public class SecurityQuestion2 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form SecurityQuestion2
     */
    ...
    private void initComponents() {
        ...
        getContentPane().add(lbl_headline, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 10, 340, -1));

        lbl_NIC.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lbl_NIC.setForeground(new java.awt.Color(255, 255, 255));
        lbl_NIC.setText("NIC ");
        getContentPane().add(lbl_NIC, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 110, -1, -1));
        ...
        getContentPane().add(lbl_q1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 200, -1, -1));
        ...
        getContentPane().add(lbl_q2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 290, -1, -1));
        ...
        getContentPane().add(lbl_q3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 380, -1, -1));
        getContentPane().add(txt_NIC, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 90, 430, 50));
        getContentPane().add(txt_q1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 180, 430, 50));
        getContentPane().add(txt_q2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 280, 430, 50));
        getContentPane().add(txt_q3, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 370, 430, 50));

        lbl_logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Logo_size_3.png"))); // NOI18N
        getContentPane().add(lbl_logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 580, 50, 50));
        ...
        getContentPane().add(lbl_Footer, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 600, -1, 20));
        ...
        getContentPane().add(btn_Submit, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 530, 180, 50));

        lbl_data.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lbl_data.setForeground(new java.awt.Color(255, 255, 255));
        lbl_data.setText("You can use the Questions to verify your account to change Password.");
        getContentPane().add(lbl_data, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 480, -1, -1));
        ...
        getContentPane().add(lbl_back, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 550, 110, 80));
    ...
    private void lbl_backMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_backMouseClicked
        ...
        V_home_admin a=new V_home_admin();
        a.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SecurityQuestion2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SecurityQuestion2().setVisible(true);
            }
        });
    }
